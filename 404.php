...
<div class="page-header py-32">
	<div class="container flex flex-col gap-4 justify-center items-center">
		<h1 class="t-1 font-bold text-primary-500 page-header__title leading-none font-serif" >404</h1>
		<div class="t-3 text-primary-500 leading-none"><?php _e('Pagina non trovata','mongolfiera')?></div>
