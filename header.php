    ...
    <div class="site-topbar bg-secondary-500 text-primary-500">
        <div class="container mx-auto px-4">
            <div class="flex flex-wrap items-center justify-between gap-2 py-2">
                <div class="flex items-center gap-1 lg:gap-2 shrink-0 desc-3 lg:desc-2">
                    <?php if ( $orari_negozi ) : ?>
                        ...
                        <span class="font-bold uppercase tracking-wide hidden lg:block"><?php esc_html_e( 'Orari', 'mongolfiera' ); ?></span>
        ...
        <div class="container mx-auto px-4 h-full">
            <div class="flex items-center justify-between h-full py-4">
                ...
                <div class="flex gap-4 md:gap-5 items-center h-full">
                    ...
                    <div class="site-header__menu-trigger 2xl:hidden"><?php get_template_part('images/icons/menu') ?></div>
                </div>
            </div>
        </div><!--/.container-->
    </header>
